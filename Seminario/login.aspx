...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_cuerpo" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" runat="server" id="tb_usuario" class="form-control" placeholder="Usuario" required autofocus />
            <br />
            <label for="inputPassword" class="sr-only">Password</label>
            <input type="password" id="tb_clave" runat="server" class="form-control" placeholder="Contraseña" required />
            <br />
