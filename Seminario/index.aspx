<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Seminario.index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="css/index.css?crc=4286609721" id="pagesheet" />
    <!-- JS includes -->
    <!--[if lt IE 9]>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_cuerpo" runat="server">
    ...
    <div class="position_content" id="page_position_content">
        <div class="clearfix colelem" id="ppu3678">
            <!-- group -->
            <div class="clearfix grpelem" id="pu3678">
                <!-- column -->
                <div class="clip_frame colelem" id="u3678">
                    <!-- image -->
                    <img class="block" id="u3678_img" src="images/fondo2.jpg?crc=89978585" alt="" width="1199" height="458" />
                </div>
                <div class="browser_width colelem" id="u10044-bw">
                    <div id="u10044">
                        <!-- group -->
                        <div class="clearfix" id="u10044_align_to_page">
                            <div class="clearfix grpelem" id="u1556-4">
                                <!-- content -->
                                <p>BIENVENIDOS AL PORTAL DE INGRESO Y PERMANENCIA</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="clearfix grpelem" id="u1552-4">
                <!-- content -->
                <p>¿Inicias en la UTN?</p>
            </div>
        </div>
        <div class="verticalspacer" data-offset-top="718" data-content-above-spacer="725" data-content-below-spacer="97"></div>
    </div>
    <br />
    <!-- Other scripts -->
    <script type="text/javascript">
