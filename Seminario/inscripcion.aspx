<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="inscripcion.aspx.cs" Inherits="Seminario.inscripcion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        if (typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = { "required": ["museutils.js", "museconfig.js", "jquery.watch.js", "jquery.musemenu.js", "require.js", "inscripci_n.css"], "outOfDate": [] };
</script>

    <link rel="shortcut icon" href="images/favicon.ico?crc=424358116" />
    <title>InscripciónUTN-FRRE</title>
    <!-- CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="css/inscripci_n.css?crc=4088183331" id="pagesheet" />
    <!-- JS includes -->
    <!--[if lt IE 9]>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_cuerpo" runat="server">
    ...
    <div class="clearfix colelem" id="pu5366">
        ...
        <div class="clearfix grpelem" id="u10084">
            <!-- column -->
            <div class="clearfix colelem" id="pu4981">
                <!-- group -->
                <div class="grpelem" id="u4981">
                    <!-- simple frame -->
                </div>
                <div class="clearfix grpelem" id="u4982-3">
                    <!-- content -->
                    <p>&nbsp;</p>
                </div>
                <div class="clearfix grpelem" id="u4983-4">
                    <!-- content -->
                    <p>Requisitos de Inscripción</p>
                </div>
            </div>
            <div class="clearfix colelem" id="u5079-13">
                <!-- content -->
                <ul class="list0 nls-None" id="u5079-9">
                    <li>Fotocopia del DNI (primera y segunda hoja).</li>
                    <li>Fotocopia legalizada del título de nivel secundario o constancia de alumno regular (para aquellos que están cursando el último año de la escuela secundaria).</li>
                    <li>Folio tamaño oficio.</li>
                    <li>FORMULARIO DE PRE-INSCRIPCIÓN impreso y firmado.</li>
                </ul>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
            </div>
            <div class="clearfix colelem" id="pu4984">
                <!-- group -->
                <div class="grpelem" id="u4984">
                    <!-- simple frame -->
                </div>
                <div class="clearfix grpelem" id="u4985-3">
                    <!-- content -->
                    <p>&nbsp;</p>
                </div>
                <div class="clearfix grpelem" id="u4986-4">
                    <!-- content -->
                    <p>Formulario de Pre-inscripción</p>
                </div>
            </div>
            <div class="clearfix colelem" id="u5082">
                <!-- group -->
                <div class="clearfix grpelem" id="u5408-5">
                    <!-- content -->
                    <p><a class="nonblock" href="http://www.frre.utn.edu.ar/academica/inscripcion/" target="_blank"><span id="u5408">Formulario de Pre-inscripción</span></a></p>
                </div>
            </div>
        </div>
    </div>
